...
class MAC_Tracker_Admin {
	...
	public function render_projects() {
		...
		<form class="mac-tracker-filters" method="get" action="<?php echo esc_url( $this->app_url( 'projects' ) ); ?>">
			...
			<div class="mac-tracker-filter-custom" data-mac-project-custom-range role="group" aria-label="Custom date range"<?php echo 'custom' === $filters['range'] ? '' : ' hidden'; ?>><label><span>From</span><input type="date" name="custom_from" value="<?php echo esc_attr( $filters['custom_from'] ); ?>"></label><label><span>To</span><input type="date" name="custom_to" value="<?php echo esc_attr( $filters['custom_to'] ); ?>"></label></div>
