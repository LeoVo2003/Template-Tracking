...
class MAC_Tracker_Repository {
	...
	private function visual_source_action( $value ) { $value = sanitize_key( (string) $value ); return in_array( $value, array( 'analyze_selected', 'capture_selected_again', 'capture_and_analyze_selected', 'retry_failed_capture', 'retry_failed_analysis', 'analyze_all_stored', 'run_batch_now', 'scheduled_auto' ), true ) ? $value : 'run_batch_now'; }
