...
const primaryWord = { white: 'Trắng', ivory: 'Trắng', cream: 'Kem', beige: 'Be', greige: 'Greige', gray: 'Xám', charcoal: 'Charcoal', black: 'Đen', taupe: 'Taupe', brown: 'Nâu', terracotta: 'Cam đất', orange: 'Cam', peach: 'Đào', yellow: 'Vàng', gold: 'Gold', champagne: 'Champagne', red: 'Đỏ', burgundy: 'Đỏ rượu', pink: 'Hồng', rose: 'Rose', dusty_rose: 'Hồng đất', purple: 'Tím', lavender: 'Lavender', green: 'Xanh lá', olive: 'Olive', sage: 'Sage', blue: 'Xanh dương', navy: 'Navy', teal: 'Teal', aqua: 'Xanh ngọc' };
